...
if __name__ == '__main__':
    ...
    parser = argparse.ArgumentParser(description='Standalone true-class phase6 runner for VisA')
    parser.add_argument('--data_path', type=str, default='../VisA_pytorch/1cls')
    parser.add_argument('--save_dir', type=str, default='./saved_results')
    parser.add_argument('--save_name', type=str, default='vitill_visa_phase6_true_class')
