...
tailguard
```bash
python dinomaly_mvtec_tailguard.py --data_path ../LTN_datasets/mvtecad-pareto-seed01 --save_dir ../results/tailguard --save_name tailguard_pareto --tailsampler_type adaptive_trim_mode --tg_tail_embedding_source encoder_cls --gbps_embedding_source encoder --gbps_postprocess_mode remove --tg_memory_enable --gpus 1
python dinomaly_mvtec_tailguard.py --data_path ../LTN_datasets/mvtecad-step_k4-seed01 --save_dir ../results/tailguard --save_name tailguard_k4 --tailsampler_type adaptive_trim_mode --tg_tail_embedding_source encoder_cls --gbps_embedding_source encoder --gbps_postprocess_mode remove --tg_memory_enable --gpus 2
python dinomaly_mvtec_tailguard.py --data_path ../LTN_datasets/mvtecad-step_k1-seed01 --save_dir ../results/tailguard --save_name tailguard_k1 --tailsampler_type adaptive_trim_mode --tg_tail_embedding_source encoder_cls --gbps_embedding_source encoder --gbps_postprocess_mode remove --tg_memory_enable --gpus 3
```